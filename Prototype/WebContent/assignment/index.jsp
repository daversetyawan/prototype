			...
			<div class="span12">
				<div class="content-taps">
					<table class="table">
						<thead>
							<tr>
								<th colspan=3 class="text-center">Employee Report
									(employee)</th>
							</tr>
						</thead>
						<tbody>
					...
					<table class="table striped bordered hovered">
						...
						<tbody>
							<tr>
								...
								<td class="text-center">2013-11-20</td>
								<td class="text-center">2013-11-14</td>
								<td class="text-center"><a href="claim_viewonly.jsp">Claim</a></td>
							</tr>
							<tr>
								<td class="text-center">2013-11-14</td>
								<td class="text-center">PRJ131100002</td>
							...
							<tr>
								...
								<td class="text-center">2013-11-20</td>
								<td class="text-center">2013-11-14</td>
								<td class="text-center"><a href="approval_s.jsp">RFA</a></td>
							</tr>
							<tr>
								<td class="text-center">2013-11-14</td>
								<td class="text-center">PRJ131100002</td>
							...
							<tr>
								...
								<td class="text-center">2013-11-20</td>
								<td class="text-center">2013-11-14</td>
								<td class="text-center"><a href="view_s.jsp">Approved</a></td>
							</tr>
							<tr>
								<td colspan=5 class="text-center">
									<div class="pagination">
